...
export interface IndicatorsChangedPayload {
    fileId: string;
...
export type OcrPluginEvent = 
    | { type: 'indicators-changed'; payload: IndicatorsChangedPayload };
...
export class OcrProvider implements IOcrProvider {
    ...
    constructor(processors: IOcrProcessor[]) {
